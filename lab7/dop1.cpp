/*4. Три приятеля были свидетелями нарушения правил дорожного движения. 
...
int main()
{
	...
	using namespace std;
	int chislo1, chislo2, chislo3, chislo4; // номер состоит из двух двухзначных чисел, сумма которых = 30
